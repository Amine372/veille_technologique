...
<head>
    ...
    <title>Amine NAKHIL | Projets</title>
                    ...
                    <div class="blog_left_sidebar">
                        <article class="blog_item">
                            ...
                            <div class="blog_details">
                                <a class="d-inline-block" href="projet_poemes.html">
                                    <h2 class="blog-head" style="color: #2d2d2d;">Générateur de poèmes</h2>
                                </a>
                                <p>Passionné de littérature, il n'a pas fallu longtemps pour que je décide de réconcilier poésie et informatique. Ainsi, dans la lignée de la poèsie combinatoire, j'ai décidé de faire un générateur de poèmes.</p>
                                <ul class="blog-info-link">
                                    <li><a href="#"><i class="fa fa-user"></i> Littérature, Informatique</a></li>
                                                                  </ul>
                            </div>
                        </article>
                        <article class="blog_item">
                            ...
                            <div class="blog_details">
                                ...
                                <ul class="blog-info-link">
                                    <li><a href="#"><i class="fa fa-user"></i> Développement web, bureautique</a></li>
                                </ul>
                            </div>
                        </article>
                        <article class="blog_item">
                            ...
                            <div class="blog_details">
                                ...
                                <ul class="blog-info-link">
                                    <li><a href="#"><i class="fa fa-user"></i> HTML5, CSS3, PHP, POO</a></li>
                                </ul>
                            </div>
                        </article>
                        <article class="blog_item">
                            ...
                            <div class="blog_details">
                                ...
                                <ul class="blog-info-link">
                                    <li><a href="#"><i class="fa fa-user"></i> Python, Pygame</a></li>
                                </ul>
                            </div>
                        </article>
                        <article class="blog_item">
                            ...
                            <div class="blog_details">
                                ...
                                <ul class="blog-info-link">
                                    <li><a href="#"><i class="fa fa-user"></i> HTML, CSS, PHP, POO</a></li>
                                </ul>
                            </div>
                        </article>
                        <article class="blog_item">
